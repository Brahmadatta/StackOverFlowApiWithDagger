package example.com.stackoverflowapiproject.screens.questionList.common.fragmentframehelper;
...
public class FragmentFrameHelper {
    ...
    public void navigateUp() {
        ...
        Fragment currentFragmet = getCurrentFragment();
        ...
        if (mFragmentManager.getBackStackEntryCount() > 0){
            ...
            if (mFragmentManager.popBackStackImmediate()){
                return; //navigate "Up" in fragments back-stack
            }
        }

        if (HierarchicalFragment.class.isInstance(currentFragmet)){
            Fragment parentFragment = ((HierarchicalFragment)currentFragmet).getHierarchicalParentFragment();

            if (parentFragment != null){
                replaceFragment(parentFragment,false,true);
                return; //navigate "up" to hierarchichal parent fragment
            }
        }
